...
<div class="page-header">
    ...
    <div>
        ...
        <h1 class="page-title">
            Ajouter un <span class="red">véhicule</span>
        </h1>

        <p class="page-subtitle">
            Ajoutez un nouveau véhicule à votre catalogue
        </p>
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Essence"
                            {{ old('carburant') == 'Essence' ? 'selected' : '' }}>
                            Essence
                        </option>

                        <option value="Diesel"
                            {{ old('carburant') == 'Diesel' ? 'selected' : '' }}>
                            Diesel
                        </option>

                        <option value="Hybride"
                            {{ old('carburant') == 'Hybride' ? 'selected' : '' }}>
                            Hybride
                        </option>

                        <option value="Electrique"
                            {{ old('carburant') == 'Electrique' ? 'selected' : '' }}>
                            Électrique
                        </option>
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Manuelle"
                            {{ old('boite_vitesse') == 'Manuelle' ? 'selected' : '' }}>
                            Manuelle
                        </option>

                        <option value="Automatique"
                            {{ old('boite_vitesse') == 'Automatique' ? 'selected' : '' }}>
                            Automatique
                        </option>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Vendu"
                            {{ old('statut') == 'Vendu' ? 'selected' : '' }}>
                            Vendu
                        </option>

                        <option value="Reserve"
                            {{ old('statut') == 'Reserve' ? 'selected' : '' }}>
                            Réservé
                        </option>
                ...
                <div class="form-group full">
                    ...
                    <textarea
                        ...
                        id="description"
                        name="description"
                        placeholder="Décrivez le véhicule, ses équipements, son état...">{{ old('description') }}</textarea>
