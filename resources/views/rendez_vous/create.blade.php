...
<div class="rdv-form-page">
    ...
    <div class="form-header">
        ...
        <p>Planifiez une visite client pour un véhicule.</p>
    </div>
    ...
    <div class="form-card">
        ...
        <form
            action="{{ route('rendez_vous.store') }}"
            method="POST"
        >
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <select
                        name="client_id"
                        id="client_id"
                        class="select @error('client_id') is-invalid @enderror"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        <option
                            value="En attente"
                            {{ old('statut', 'En attente') === 'En attente' ? 'selected' : '' }}
                        >
                            En attente
                        </option>
                ...
                <div class="form-group full">
                    ...
                    <textarea
                        ...
                        id="message"
                        class="textarea"
                        placeholder="Exemple : Le client souhaite essayer le véhicule..."
            ...
            <div class="info-box">
                ...
                seuls les véhicules disponibles sont proposés dans la liste.
                Vous pourrez modifier le rendez-vous ultérieurement.
            </div>
