...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="menu">
                ...
                <a href="{{ route('vehicules.index') }}" class="menu-link {{ request()->routeIs('vehicules.*') ? 'active' : '' }}">
                    <div class="menu-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="{{ route('marques.index') }}" class="menu-link {{ request()->routeIs('marques.index') ? 'active' : '' }}">
                    <div class="menu-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="{{ route('clients.index') }}" class="menu-link {{ request()->routeIs('clients.*') ? 'active' : '' }}">
                    <div class="menu-icon">
                            <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="{{ route('ventes.index') }}" class="menu-link {{ request()->routeIs('ventes.*') ? 'active' : '' }}">
                <div class="menu-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="#" class="menu-link {{ request()->routeIs('rendez-vous.*') ? 'active' : '' }}">
                    <div class="menu-icon">
                        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
